...
23. `UNIFIED_RESOURCE_LEASE_LOCKING_REVIEW_2026_06_24.adoc` +
   ...
   link:LEASE_INFRASTRUCTURE_CONSOLIDATION_HLD.md[lease infrastructure consolidation: interface index,
   ownership/publication/progress semantics, reuse boundaries and adversarial TDD gates]
   (TD-LEASE-INFRA-1; no new public lease authority).
