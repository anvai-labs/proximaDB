...
/// The v2 file-descriptor set (`proximadb.v2_descriptor.bin`, regenerated by
/// `PROXIMADB_PROTO_REGEN=1` together with the stubs) — registered by the gRPC
/// server reflection service so clients can DISCOVER the canonical v2 surface.
pub const V2_FILE_DESCRIPTOR_SET: &[u8] = include_bytes!("proto/proximadb.v2_descriptor.bin");
